...
public class KafkaShowConfig extends KafkaConfig {
    @Bean
    public ProducerFactory<String, AbstractShowableEntity> showProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, AbstractShowableEntity> showKafkaTemplate(
...
//                new JsonDeserializer<>(ShowableGetter.class, false));
    ...
    showKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ShowableGetter> factory =
