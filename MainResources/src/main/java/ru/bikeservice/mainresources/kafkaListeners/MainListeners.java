...
//        } else {
//            switch (category) {
//                case "Document" -> list.addAll(documentService.getAll());
//                case "Fastener" -> list.addAll(fastenerService.getAll());
//                case "Manufacturer" -> list.addAll(manufacturerService.getAll());
//                case "Consumable" -> list.addAll(consumableService.getAll());
//                case "Tool" -> list.addAll(toolService.getAll());
//                case "Part" -> list.addAll(partService.getAll());
//                case "Bike" -> list.addAll(bikeService.getAll());
//            }
//        }
