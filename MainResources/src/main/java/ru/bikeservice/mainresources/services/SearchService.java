...
import ru.bikeservice.mainresources.models.dto.UserDTO;
...
public class SearchService {
    ...
    public List<AbstractShowableEntity> doSearchProcedure(
            String findBy, String searchValue, final UserDTO userModel, boolean shared, String category) throws ExecutionException, InterruptedException {
    ...
    private List<AbstractShowableEntity> getAdminResults(
            String findBy, String searchValue, final UserDTO userModel, String category
    ) {
    ...
    protected List<AbstractShowableEntity> getUserResults(
            String findBy, String searchValue, final UserDTO userModel, boolean shared, String category) {
        List<AbstractShowableEntity> results = new ArrayList<>();
    ...
    public List<AbstractShowableEntity> doGlobalSearchProcedure(
            String findBy, String searchValue, final UserDTO userModel, boolean shared) throws ExecutionException, InterruptedException {
        List<AbstractShowableEntity> results = new ArrayList<>();
    ...
    private List<AbstractShowableEntity> findAllByNameOrShared(final String searchValue, final UserDTO userModel, boolean shared) {
//        List<AbstractShowableEntity> results = new ArrayList<>();
...
//        return results;
    ...
    private List<AbstractShowableEntity> findAllByDescriptionOrShared(final String searchValue, final UserDTO userModel, boolean shared) {
//        List<AbstractShowableEntity> results = new ArrayList<>();
...
//        return results;
    ...
    private List<AbstractShowableEntity> findAllByValueOrShared(final String searchValue, final UserDTO userModel, boolean shared) {
//        List<AbstractShowableEntity> results = new ArrayList<>();
...
//        return results;
    ...
    private List<AbstractUsableEntity> findAllByManufacturer(final String searchValue, final UserDTO userModel, boolean shared) {
//        List<AbstractShowableEntity> results = new ArrayList<>();
...
//        return results;
    ...
    private List<AbstractUsableEntity> findAllByModelOrShared(final String searchValue, final UserDTO userModel, boolean shared) {
//        List<AbstractShowableEntity> results = new ArrayList<>();
...
//        return results;
    ...
    private List<AbstractShowableEntity> findByNameCreatorShared(String searchValue, String category, UserDTO userModel, boolean shared) {
        List<AbstractShowableEntity> results = new ArrayList<>();
        switch (category) {
            case "documents" ->
    ...
    private List<AbstractShowableEntity> findByDescriptionCreatorShared(String searchValue, String category, UserDTO userModel, boolean shared) {
        List<AbstractShowableEntity> results = new ArrayList<>();
    ...
    private List<AbstractShowableEntity> findByValueCreatorShared(String searchValue, String category, UserDTO userModel, boolean shared) {
        List<AbstractShowableEntity> results = new ArrayList<>();
    ...
    private List<AbstractUsableEntity> findByManufactureCreatorShared(String searchValue, String category, UserDTO userModel, boolean shared) {
        List<AbstractUsableEntity> results = new ArrayList<>();
    ...
    private List<AbstractUsableEntity> findByModelCreatorShared(String searchValue, String category, UserDTO userModel, boolean shared) {
        List<AbstractUsableEntity> results = new ArrayList<>();
